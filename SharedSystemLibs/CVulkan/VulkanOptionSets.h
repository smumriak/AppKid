...
AK_EXISTING_OPTIONS(VkShaderModuleCreateFlagBits);
...
AK_EXISTING_OPTIONS(VkAcquireProfilingLockFlagBitsKHR);
...
AK_EXISTING_OPTIONS(VkPipelineCompilerControlFlagBitsAMD);
AK_EXISTING_OPTIONS(VkPipelineCreationFeedbackFlagBitsEXT);
AK_EXISTING_OPTIONS(VkShaderCorePropertiesFlagBitsAMD);
...
AK_EXISTING_OPTIONS(VkPrivateDataSlotCreateFlagBitsEXT);
