...
// TODO: smumriak: This code should be moved to Screen class when refactoring will be performed
internal extension X11DisplayServer {
    ...
    var gtkDisplayScale: CInt? {
        return try? DylibWrapper.perform(on: "libgdk-3.so") {
            ...
            guard let gtkDisplay = gdk_display_open(display.handle.display_name) else {
                return nil
            }
