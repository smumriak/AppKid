...
open class Window {
    ...
    internal var screen: Application.Screen
    ...
    internal init(x11Window: CX11.Window, display: Application.Display = Application.shared.display, screen: Application.Screen = Application.shared.screen) {
