...
// #*# Metadata version: 1
// #*# Date generated: '2023-07-01 04:40:34Z'
...
AK_EXISTING_ENUM(VkBuildMicromapModeEXT);
...
AK_EXISTING_ENUM(VkDeviceFaultAddressTypeEXT);
AK_EXISTING_ENUM(VkDeviceFaultVendorBinaryHeaderVersionEXT);
AK_EXISTING_ENUM(VkDeviceMemoryReportEventTypeEXT);
AK_EXISTING_ENUM(VkDirectDriverLoadingModeLUNARG);
...
AK_EXISTING_ENUM(VkMicromapTypeEXT);
AK_EXISTING_ENUM(VkObjectType);
AK_EXISTING_ENUM(VkOpacityMicromapFormatEXT);
AK_EXISTING_ENUM(VkOpacityMicromapSpecialIndexEXT);
AK_EXISTING_ENUM(VkOpticalFlowPerformanceLevelNV);
AK_EXISTING_ENUM(VkOpticalFlowSessionBindingPointNV);
...
AK_EXISTING_ENUM(VkRayTracingInvocationReorderModeNV);
