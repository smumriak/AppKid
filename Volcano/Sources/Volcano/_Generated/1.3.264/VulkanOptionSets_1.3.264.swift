...
// #*# Metadata version: 1
// #*# Date generated: '2023-09-10 05:16:06Z'
...
//
    ...
    public typealias VkBufferUsageFlagBits2KHR = CVulkan.VkBufferUsageFlagBits2KHR
    public extension VkBufferUsageFlagBits2KHR {
        static let transferSource: VkBufferUsageFlagBits2KHR = .VK_BUFFER_USAGE_2_TRANSFER_SRC_BIT_KHR
        static let transferDestination: VkBufferUsageFlagBits2KHR = .VK_BUFFER_USAGE_2_TRANSFER_DST_BIT_KHR
        static let uniformTexelBuffer: VkBufferUsageFlagBits2KHR = .VK_BUFFER_USAGE_2_UNIFORM_TEXEL_BUFFER_BIT_KHR
        static let storageTexelBuffer: VkBufferUsageFlagBits2KHR = .VK_BUFFER_USAGE_2_STORAGE_TEXEL_BUFFER_BIT_KHR
        static let uniformBuffer: VkBufferUsageFlagBits2KHR = .VK_BUFFER_USAGE_2_UNIFORM_BUFFER_BIT_KHR
        static let storageBuffer: VkBufferUsageFlagBits2KHR = .VK_BUFFER_USAGE_2_STORAGE_BUFFER_BIT_KHR
        static let indexBuffer: VkBufferUsageFlagBits2KHR = .VK_BUFFER_USAGE_2_INDEX_BUFFER_BIT_KHR
        static let vertexBuffer: VkBufferUsageFlagBits2KHR = .VK_BUFFER_USAGE_2_VERTEX_BUFFER_BIT_KHR
        static let indirectBuffer: VkBufferUsageFlagBits2KHR = .VK_BUFFER_USAGE_2_INDIRECT_BUFFER_BIT_KHR
        static let executionGraphScratchAmdx: VkBufferUsageFlagBits2KHR = .VK_BUFFER_USAGE_2_EXECUTION_GRAPH_SCRATCH_BIT_AMDX
        static let conditionalRenderingExt: VkBufferUsageFlagBits2KHR = .VK_BUFFER_USAGE_2_CONDITIONAL_RENDERING_BIT_EXT
        static let shaderBindingTable: VkBufferUsageFlagBits2KHR = .VK_BUFFER_USAGE_2_SHADER_BINDING_TABLE_BIT_KHR
        static let rayTracingNv: VkBufferUsageFlagBits2KHR = .VK_BUFFER_USAGE_2_RAY_TRACING_BIT_NV
        static let transformFeedbackBufferExt: VkBufferUsageFlagBits2KHR = .VK_BUFFER_USAGE_2_TRANSFORM_FEEDBACK_BUFFER_BIT_EXT
        static let transformFeedbackCounterBufferExt: VkBufferUsageFlagBits2KHR = .VK_BUFFER_USAGE_2_TRANSFORM_FEEDBACK_COUNTER_BUFFER_BIT_EXT
        static let videoDecodeSource: VkBufferUsageFlagBits2KHR = .VK_BUFFER_USAGE_2_VIDEO_DECODE_SRC_BIT_KHR
        static let videoDecodeDestination: VkBufferUsageFlagBits2KHR = .VK_BUFFER_USAGE_2_VIDEO_DECODE_DST_BIT_KHR
        static let shaderDeviceAddress: VkBufferUsageFlagBits2KHR = .VK_BUFFER_USAGE_2_SHADER_DEVICE_ADDRESS_BIT_KHR
        static let accelerationStructureBuildInputReadOnly: VkBufferUsageFlagBits2KHR = .VK_BUFFER_USAGE_2_ACCELERATION_STRUCTURE_BUILD_INPUT_READ_ONLY_BIT_KHR
        static let accelerationStructureStorage: VkBufferUsageFlagBits2KHR = .VK_BUFFER_USAGE_2_ACCELERATION_STRUCTURE_STORAGE_BIT_KHR
        static let samplerDescriptorBufferExt: VkBufferUsageFlagBits2KHR = .VK_BUFFER_USAGE_2_SAMPLER_DESCRIPTOR_BUFFER_BIT_EXT
        static let resourceDescriptorBufferExt: VkBufferUsageFlagBits2KHR = .VK_BUFFER_USAGE_2_RESOURCE_DESCRIPTOR_BUFFER_BIT_EXT
        static let pushDescriptorsDescriptorBufferExt: VkBufferUsageFlagBits2KHR = .VK_BUFFER_USAGE_2_PUSH_DESCRIPTORS_DESCRIPTOR_BUFFER_BIT_EXT
        static let micromapBuildInputReadOnlyExt: VkBufferUsageFlagBits2KHR = .VK_BUFFER_USAGE_2_MICROMAP_BUILD_INPUT_READ_ONLY_BIT_EXT
        static let micromapStorageExt: VkBufferUsageFlagBits2KHR = .VK_BUFFER_USAGE_2_MICROMAP_STORAGE_BIT_EXT
    }
    ...
    public extension VkDescriptorPoolCreateFlagBits {
        ...
        static let allowOverallocationSetsNv: VkDescriptorPoolCreateFlagBits = .VK_DESCRIPTOR_POOL_CREATE_ALLOW_OVERALLOCATION_SETS_BIT_NV
        static let allowOverallocationPoolsNv: VkDescriptorPoolCreateFlagBits = .VK_DESCRIPTOR_POOL_CREATE_ALLOW_OVERALLOCATION_POOLS_BIT_NV
    }
    ...
    public extension VkDescriptorSetLayoutCreateFlagBits {
        ...
        static let indirectBindableNv: VkDescriptorSetLayoutCreateFlagBits = .VK_DESCRIPTOR_SET_LAYOUT_CREATE_INDIRECT_BINDABLE_BIT_NV
    ...
    public extension VkExternalMemoryHandleTypeFlagBits {
        ...
        static let screenBufferQnx: VkExternalMemoryHandleTypeFlagBits = .VK_EXTERNAL_MEMORY_HANDLE_TYPE_SCREEN_BUFFER_BIT_QNX
    }
    ...
    public typealias VkFrameBoundaryFlagBitsEXT = CVulkan.VkFrameBoundaryFlagBitsEXT
    public extension VkFrameBoundaryFlagBitsEXT {
        static let frameEnd: VkFrameBoundaryFlagBitsEXT = .VK_FRAME_BOUNDARY_FRAME_END_BIT_EXT
    }
    ...
    public typealias VkHostImageCopyFlagBitsEXT = CVulkan.VkHostImageCopyFlagBitsEXT
    public extension VkHostImageCopyFlagBitsEXT {
        static let memcpy: VkHostImageCopyFlagBitsEXT = .VK_HOST_IMAGE_COPY_MEMCPY_EXT
    }
    ...
    public extension VkImageUsageFlagBits {
        ...
        static let hostTransferExt: VkImageUsageFlagBits = .VK_IMAGE_USAGE_HOST_TRANSFER_BIT_EXT
    ...
    public typealias VkPipelineCreateFlagBits2KHR = CVulkan.VkPipelineCreateFlagBits2KHR
    public extension VkPipelineCreateFlagBits2KHR {
        static let disableOptimization: VkPipelineCreateFlagBits2KHR = .VK_PIPELINE_CREATE_2_DISABLE_OPTIMIZATION_BIT_KHR
        static let allowDerivatives: VkPipelineCreateFlagBits2KHR = .VK_PIPELINE_CREATE_2_ALLOW_DERIVATIVES_BIT_KHR
        static let derivative: VkPipelineCreateFlagBits2KHR = .VK_PIPELINE_CREATE_2_DERIVATIVE_BIT_KHR
        static let viewIndexFromDeviceIndex: VkPipelineCreateFlagBits2KHR = .VK_PIPELINE_CREATE_2_VIEW_INDEX_FROM_DEVICE_INDEX_BIT_KHR
        static let dispatchBase: VkPipelineCreateFlagBits2KHR = .VK_PIPELINE_CREATE_2_DISPATCH_BASE_BIT_KHR
        static let deferCompileNv: VkPipelineCreateFlagBits2KHR = .VK_PIPELINE_CREATE_2_DEFER_COMPILE_BIT_NV
        static let captureStatistics: VkPipelineCreateFlagBits2KHR = .VK_PIPELINE_CREATE_2_CAPTURE_STATISTICS_BIT_KHR
        static let captureInternalRepresentations: VkPipelineCreateFlagBits2KHR = .VK_PIPELINE_CREATE_2_CAPTURE_INTERNAL_REPRESENTATIONS_BIT_KHR
        static let failOnPipelineCompileRequired: VkPipelineCreateFlagBits2KHR = .VK_PIPELINE_CREATE_2_FAIL_ON_PIPELINE_COMPILE_REQUIRED_BIT_KHR
        static let earlyReturnOnFailure: VkPipelineCreateFlagBits2KHR = .VK_PIPELINE_CREATE_2_EARLY_RETURN_ON_FAILURE_BIT_KHR
        static let linkTimeOptimizationExt: VkPipelineCreateFlagBits2KHR = .VK_PIPELINE_CREATE_2_LINK_TIME_OPTIMIZATION_BIT_EXT
        static let retainLinkTimeOptimizationInfoExt: VkPipelineCreateFlagBits2KHR = .VK_PIPELINE_CREATE_2_RETAIN_LINK_TIME_OPTIMIZATION_INFO_BIT_EXT
        static let library: VkPipelineCreateFlagBits2KHR = .VK_PIPELINE_CREATE_2_LIBRARY_BIT_KHR
        static let rayTracingSkipTriangles: VkPipelineCreateFlagBits2KHR = .VK_PIPELINE_CREATE_2_RAY_TRACING_SKIP_TRIANGLES_BIT_KHR
        static let rayTracingSkipAabbs: VkPipelineCreateFlagBits2KHR = .VK_PIPELINE_CREATE_2_RAY_TRACING_SKIP_AABBS_BIT_KHR
        static let rayTracingNoNullAnyHitShaders: VkPipelineCreateFlagBits2KHR = .VK_PIPELINE_CREATE_2_RAY_TRACING_NO_NULL_ANY_HIT_SHADERS_BIT_KHR
        static let rayTracingNoNullClosestHitShaders: VkPipelineCreateFlagBits2KHR = .VK_PIPELINE_CREATE_2_RAY_TRACING_NO_NULL_CLOSEST_HIT_SHADERS_BIT_KHR
        static let rayTracingNoNullMissShaders: VkPipelineCreateFlagBits2KHR = .VK_PIPELINE_CREATE_2_RAY_TRACING_NO_NULL_MISS_SHADERS_BIT_KHR
        static let rayTracingNoNullIntersectionShaders: VkPipelineCreateFlagBits2KHR = .VK_PIPELINE_CREATE_2_RAY_TRACING_NO_NULL_INTERSECTION_SHADERS_BIT_KHR
        static let rayTracingShaderGroupHandleCaptureReplay: VkPipelineCreateFlagBits2KHR = .VK_PIPELINE_CREATE_2_RAY_TRACING_SHADER_GROUP_HANDLE_CAPTURE_REPLAY_BIT_KHR
        static let indirectBindableNv: VkPipelineCreateFlagBits2KHR = .VK_PIPELINE_CREATE_2_INDIRECT_BINDABLE_BIT_NV
        static let rayTracingAllowMotionNv: VkPipelineCreateFlagBits2KHR = .VK_PIPELINE_CREATE_2_RAY_TRACING_ALLOW_MOTION_BIT_NV
        static let renderingFragmentShadingRateAttachment: VkPipelineCreateFlagBits2KHR = .VK_PIPELINE_CREATE_2_RENDERING_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR
        static let renderingFragmentDensityMapAttachmentExt: VkPipelineCreateFlagBits2KHR = .VK_PIPELINE_CREATE_2_RENDERING_FRAGMENT_DENSITY_MAP_ATTACHMENT_BIT_EXT
        static let rayTracingOpacityMicromapExt: VkPipelineCreateFlagBits2KHR = .VK_PIPELINE_CREATE_2_RAY_TRACING_OPACITY_MICROMAP_BIT_EXT
        static let colorAttachmentFeedbackLoopExt: VkPipelineCreateFlagBits2KHR = .VK_PIPELINE_CREATE_2_COLOR_ATTACHMENT_FEEDBACK_LOOP_BIT_EXT
        static let depthStencilAttachmentFeedbackLoopExt: VkPipelineCreateFlagBits2KHR = .VK_PIPELINE_CREATE_2_DEPTH_STENCIL_ATTACHMENT_FEEDBACK_LOOP_BIT_EXT
        static let noProtectedAccessExt: VkPipelineCreateFlagBits2KHR = .VK_PIPELINE_CREATE_2_NO_PROTECTED_ACCESS_BIT_EXT
        static let protectedAccessOnlyExt: VkPipelineCreateFlagBits2KHR = .VK_PIPELINE_CREATE_2_PROTECTED_ACCESS_ONLY_BIT_EXT
        static let rayTracingDisplacementMicromapNv: VkPipelineCreateFlagBits2KHR = .VK_PIPELINE_CREATE_2_RAY_TRACING_DISPLACEMENT_MICROMAP_BIT_NV
        static let descriptorBufferExt: VkPipelineCreateFlagBits2KHR = .VK_PIPELINE_CREATE_2_DESCRIPTOR_BUFFER_BIT_EXT
    }
