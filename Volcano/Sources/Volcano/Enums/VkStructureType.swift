...
public extension VkStructureType {
    ...
    static let bindAccelerationStructureMemoryInfoKHR: VkStructureType = .VK_STRUCTURE_TYPE_BIND_ACCELERATION_STRUCTURE_MEMORY_INFO_KHR
    ...
    static let accelerationStructureCreateGeometryTypeInfoKHR: VkStructureType = .VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_CREATE_GEOMETRY_TYPE_INFO_KHR
    ...
    static let accelerationStructureMemoryRequirementsInfoKHR: VkStructureType = .VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_MEMORY_REQUIREMENTS_INFO_KHR
    static let accelerationStructureVersionKHR: VkStructureType = .VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_VERSION_KHR
    ...
    static let physicalDeviceRayTracingFeaturesKHR: VkStructureType = .VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_FEATURES_KHR
    static let physicalDeviceRayTracingPropertiesKHR: VkStructureType = .VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_PROPERTIES_KHR
    ...
    static let drmFormatModifierPropertiesExt: VkStructureType = .VK_STRUCTURE_TYPE_DRM_FORMAT_MODIFIER_PROPERTIES_EXT
    ...
    static let deferredOperationInfoKHR: VkStructureType = .VK_STRUCTURE_TYPE_DEFERRED_OPERATION_INFO_KHR
